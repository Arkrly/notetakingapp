...
- **Files:** 
  ...
  - `backend/src/main/java/com/backend/service/AuthService.java`
...
- **Files:** 
  - `backend/src/main/resources/application.properties` (JWT secret, DB credentials)
  - `backend/docker-compose.yaml` (database password)
...
- **Files:** `backend/docker-compose.yaml` (lines 13-17)
...
- **Files:** 
  - `backend/src/main/java/com/backend/config/SecurityConfig.java` (lines 41-48)
...
- **Files:** `backend/src/main/java/com/backend/repository/NoteRepository.java` (lines 26-32)
...
- **Files:** `backend/src/main/resources/application.properties` (line 22)
...
- **Files:** 
  - `backend/src/main/java/com/backend/config/SecurityConfig.java` (line 58)
...
- **Files:** 
  - `backend/src/main/resources/application.properties` (lines 5-7)
  - `backend/docker-compose.yaml` (lines 7-8)
...
- **Files:** `backend/src/main/java/com/backend/repository/NoteRepository.java`
...
- **Files:** 
  - `backend/src/main/java/com/backend/controller/NoteController.java` (lines 93-128)
  - `frontend/src/app/core/services/note.service.ts` (lines 93-102)
...
- **Files:** `backend/src/main/java/com/backend/service/impl/NoteServiceImpl.java` (lines 158-166)
...
- **Files:** `backend/src/main/java/com/backend/service/impl/NoteServiceImpl.java` (lines 127-130)
...
- **Files:** `backend/pom.xml` (lines 54-58)
...
- **Files:** `backend/src/main/java/com/backend/entity/User.java` (lines 79-91)
...
- **Files:** `backend/src/test/java/com/backend/`
...
- **Files:** Only `frontend/src/app/app.spec.ts` exists
...
- **Files:** `backend/src/test/java/com/backend/controller/AuthControllerTest.java`
...
- **Files:** `backend/src/main/java/com/backend/mapper/NoteMapper.java`
...
- **Files:** 
  - `backend/src/main/java/com/backend/dto/response/ApiResponse.java`
  - `backend/src/main/java/com/backend/dto/response/AuthResponse.java`
...
- **Files:** 
  - `backend/src/main/java/com/backend/exception/GlobalExceptionHandler.java`
  - `backend/src/main/java/com/backend/service/impl/AuthServiceImpl.java`
...
- **Files:** 
  - `backend/src/main/java/com/backend/service/impl/AuthServiceImpl.java`
  - `backend/src/main/java/com/backend/dto/request/LoginRequest.java`
  - `backend/src/main/java/com/backend/dto/request/RegisterRequest.java`
